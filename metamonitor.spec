...
MetaMonitor jest prostym programem monitorującym loggery systemowe
(syslog, metalog) i wyświetlającym nadchodzące komunikaty w dymkach.
Można także wybrać dowolny inny plik z logami i filtrować interesujące
wiadomości za pomocą wyrażeń regularnych.
